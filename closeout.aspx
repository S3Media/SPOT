...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" Runat="Server">
    ...
    <meta itemprop="image" content="https://skateparkoftampa.com/spot/images3/closeouticonimage.jpg">

    <meta property="og:title" content="Skateboarding Closeout in stock at SPoT Skate Shop"/>
    <meta property="og:type" content="product"/>
    <meta property="og:image" content="https://skateparkoftampa.com/spot/images3/closeouticonimage.jpg"/>
            ...
            <asp:Repeater runat="server" ID="rptMfgrs" DataSourceID="sdsMfgrs">
                ...
                <div class="col-xs-6 col-sm-4 NewArrivalSmallBlock tall">
                    <div>
                        ...
                        <img height="60" width="60" src="https://skateparkoftampa.com/spot/productimages/<%# Eval("ManufacturerID")%>mfgrthumb.jpg" title="<%#Eval("Name").ToString().Replace("\"", "")%>" />
                        </a>
                    </div>
