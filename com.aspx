<%@ Page Title="" Language="C#" MasterPageFile="SPoT.master" AutoEventWireup="true" CodeFile="com.aspx.cs" Inherits="com" %>
...
<div style="margin:2px" class="BlogPost">
...
<asp:SqlDataSource runat="server" ID="sdsFeatured" SelectCommand="SPOT2012ManufacturersFeatured" 
SelectCommandType="StoredProcedure" ConnectionString="<%$ConnectionStrings:CS %>" />

<div class="BlogPost ShoeSizeGrid" style="overflow-x:auto; overflow-y:hidden;">
<h1>Featured Companies</h1>

    <asp:Repeater ID="Repeater1" runat="server" DataSourceID="sdsFeatured">
    <ItemTemplate>
...
<div class="BlogPost">
<h1>All Skateboard Companies In Stock Right Now</h1>

<asp:SqlDataSource runat="server" ID="sdsCompanies" ConnectionString="<%$ ConnectionStrings:CS %>"
    SelectCommand="SPOT2012ManufacturerList" SelectCommandType="StoredProcedure"
