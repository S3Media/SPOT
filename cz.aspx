...
<h1>Select Your Shoe Size</h1>
    <div class="col-xs-2"><div class="SizeSelectionGridItemSmall"><a title="<%=strCompany %> <%=strCategory %> Size 5 In Stock Now" href="cz.aspx?ID=7&SID=6&M=<%=Request.QueryString["M"] %>">5</a></div></div>    <div class="col-xs-2"><div class="SizeSelectionGridItemSmall"><a title="<%=strCompany %> <%=strCategory %> Size 5.5 In Stock Now" href="cz.aspx?ID=7&SID=7&M=<%=Request.QueryString["M"] %>">5.5</a></div></div>    <div class="col-xs-2"><div class="SizeSelectionGridItemSmall"><a title="<%=strCompany %> <%=strCategory %> Size 6 In Stock Now" href="cz.aspx?ID=7&SID=8&M=<%=Request.QueryString["M"] %>">6</a></div></div>    <div class="col-xs-2"><div class="SizeSelectionGridItemSmall"><a title="<%=strCompany %> <%=strCategory %> Size 6.5 In Stock Now" href="cz.aspx?ID=7&SID=9&M=<%=Request.QueryString["M"] %>">6.5</a></div></div>    <div class="col-xs-2"><div class="SizeSelectionGridItemSmall"><a title="<%=strCompany %> <%=strCategory %> Size 7 In Stock Now" href="cz.aspx?ID=7&SID=10&M=<%=Request.QueryString["M"] %>">7</a></div></div>   <div class="col-xs-2"> <div class="SizeSelectionGridItemSmall"><a title="<%=strCompany %> <%=strCategory %> Size 7.5 In Stock Now" href="cz.aspx?ID=7&SID=11&M=<%=Request.QueryString["M"] %>">7.5</a></div></div>    <div class="col-xs-2"><div class="SizeSelectionGridItemSmall"><a title="<%=strCompany %> <%=strCategory %> Size 8 In Stock Now" href="cz.aspx?ID=7&SID=12&M=<%=Request.QueryString["M"] %>">8</a></div></div>   <div class="col-xs-2"> <div class="SizeSelectionGridItemSmall"><a title="<%=strCompany %> <%=strCategory %> Size 8.5 In Stock Now" href="cz.aspx?ID=7&SID=13&M=<%=Request.QueryString["M"] %>">8.5</a></div></div>    <div class="col-xs-2"><div class="SizeSelectionGridItemSmall"><a title="<%=strCompany %> <%=strCategory %> Size 9 In Stock Now" href="cz.aspx?ID=7&SID=14&M=<%=Request.QueryString["M"] %>">9</a></div></div>   <div class="col-xs-2"> <div class="SizeSelectionGridItemSmall"><a title="<%=strCompany %> <%=strCategory %> Size 9.5 In Stock Now" href="cz.aspx?ID=7&SID=15&M=<%=Request.QueryString["M"] %>">9.5</a></div></div>   <div class="col-xs-2"> <div class="SizeSelectionGridItemSmall"><a title="<%=strCompany %> <%=strCategory %> Size 10 In Stock Now" href="cz.aspx?ID=7&SID=16&M=<%=Request.QueryString["M"] %>">10</a></div></div>   <div class="col-xs-2"> <div class="SizeSelectionGridItemSmall"><a title="<%=strCompany %> <%=strCategory %> Size 10.5 In Stock Now" href="cz.aspx?ID=7&SID=17&M=<%=Request.QueryString["M"] %>">10.5</a></div></div>   <div class="col-xs-2"> <div class="SizeSelectionGridItemSmall"><a title="<%=strCompany %> <%=strCategory %> Size 11 In Stock Now" href="cz.aspx?ID=7&SID=18&M=<%=Request.QueryString["M"] %>">11</a></div></div>   <div class="col-xs-2"> <div class="SizeSelectionGridItemSmall"><a title="<%=strCompany %> <%=strCategory %> Size 11.5 In Stock Now" href="cz.aspx?ID=7&SID=19&M=<%=Request.QueryString["M"] %>">11.5</a></div></div>   <div class="col-xs-2"> <div class="SizeSelectionGridItemSmall"><a title="<%=strCompany %> <%=strCategory %> Size 12 In Stock Now" href="cz.aspx?ID=7&SID=20&M=<%=Request.QueryString["M"] %>">12</a></div></div>   <div class="col-xs-2"> <div class="SizeSelectionGridItemSmall"><a title="<%=strCompany %> <%=strCategory %> Size 13 In Stock Now" href="cz.aspx?ID=7&SID=22&M=<%=Request.QueryString["M"] %>">13</a></div></div>    <div class="col-xs-2"><div class="SizeSelectionGridItemSmall"><a title="<%=strCompany %> <%=strCategory %> Size 14 In Stock Now" href="cz.aspx?ID=7&SID=24&M=<%=Request.QueryString["M"] %>">14</a></div></div>    <div class="col-xs-2"><div class="SizeSelectionGridItemSmall"><a title="<%=strCompany %> <%=strCategory %> Size 15 In Stock Now" href="cz.aspx?ID=7&SID=26&M=<%=Request.QueryString["M"] %>">15</a></div></div>    <div style="clear:both; font-size:.7em; text-align:center;"><a href="c.aspx?ID=<%=Request.QueryString["ID"] %>">View All Sizes</a></div>
</div>
</asp:Panel>
